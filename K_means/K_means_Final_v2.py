# -*- coding: utf-8 -*-
"""
Created on Mon Mar 15 09:48:14 2021
...
while True:
    ...
    if calculated_pixel_value == dist_pix_value :#or iteration > 10:
        print("Game Over")
        #print(pixel_values_list)
        break
    else:
...
for loop_count in range (0, len(pixel_values_list))    :
    #print(pixel_values[loop_count], pixel_values_list[loop_count][3+user_K])
    cluster_list.append(pixel_values_list[loop_count][3+user_K])
