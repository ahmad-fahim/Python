...
image_name = "We"
im = Image.open(image_name + ".jpg", "r")
...
while True:
    ...
    for current_Centroid_value in dist_pix_value:
        ...
        for loop_counter in range(0, len(pixel_values)):
            ...
            #### Values are added with the RGB values
    ...
    for loop_counter in range(0, len(pixel_values)):
        ...
        dummy_list = pixel_values_list[loop_counter] 
        ...
        min_value_index_list.append((min_value_index, min_value))
        
        
    #print(pixel_values_list)    
        
        
    #print(min_value_index_list)
    cluster_array = []
